...
NOTE: Beginner recommendation: use the book, launcher, and your own editor together. Type short examples yourself. Use the launcher to check finished examples quickly. Use the ZIP or the launcher's Export feature when you want editable files.
